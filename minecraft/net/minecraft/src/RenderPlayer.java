...
public class RenderPlayer extends RendererLivingEntity
{
    ...
    protected void func_82439_b(AbstractClientPlayer par1, int par2, float par3)
    {
        ItemStack var4 = par1.inventory.armorItemInSlot(3 - par2);
    ...
    public void renderPlayer(AbstractClientPlayer par1, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        this.modelArmorChestplate.isSneak = this.modelArmor.isSneak = this.modelBipedMain.isSneak = par1.isSneaking();
        double var14 = par4 - (double)par1.yOffset;

        if (par1.isSneaking() && !(par1 instanceof EntityPlayerSP))
        {
            var14 -= 0.125D;
        }

        super.doRenderLiving(par1, par2, var14, par6, par8, par9);
    ...
    protected void func_96450_a(AbstractClientPlayer par1AbstractClientPlayer, double par2, double par4, double par6, String par8Str, float par9, double par10)
    {
        if (par10 < 260.0D)
        {
            ...
            if (var13 != null)
            {
                ...
                {
                    this.renderBigName(par1AbstractClientPlayer, var14.func_96652_c() + " " + var13.getDisplayName(), par2, par4 - 1.5D, par6, 64);
                }
                else
                {
                    this.renderBigName(par1AbstractClientPlayer, var14.func_96652_c() + " " + var13.getDisplayName(), par2, par4, par6, 64);
                }
    ...
    {
        this.func_82439_b((AbstractClientPlayer)par1, par2, par3);
    }
    ...
    {
        this.renderPlayer((AbstractClientPlayer)par1, par2, par4, par6, par8, par9);
    }
    ...
    {
        this.renderPlayer((AbstractClientPlayer)par1Entity, par2, par4, par6, par8, par9);
    }
}
