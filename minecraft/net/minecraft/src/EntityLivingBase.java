...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
        return (EntityLivingBase)(this.field_94063_bt.func_94550_c() != null ? this.field_94063_bt.func_94550_c() : (this.attackingPlayer != null ? this.attackingPlayer : (this.entityLivingToAttack != null ? this.entityLivingToAttack : null)));
    }
    ...
    public BaseAttributeMap func_110140_aT()
    {
        if (this.field_110155_d == null)
        {
            ...
            {
                this.field_110155_d = new ClientsideAttributeMap();
            }
        }
