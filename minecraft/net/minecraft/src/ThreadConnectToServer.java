...
class ThreadConnectToServer extends Thread
{
    ...
    public void run()
    {
        try
        {
            ...
            GuiConnecting.getNetClientHandler(this.connectingGui).addToSendQueue(new Packet2ClientProtocol(73, GuiConnecting.func_74254_c(this.connectingGui).func_110432_I().func_111285_a(), this.ip, this.port));
        }
