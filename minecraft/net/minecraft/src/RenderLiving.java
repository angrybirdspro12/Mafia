...
public abstract class RenderLiving extends RendererLivingEntity
{
    ...
    {
        return super.func_110813_b(par1EntityLiving) && (par1EntityLiving.func_94059_bO() || par1EntityLiving.func_94056_bM() && par1EntityLiving == this.renderManager.field_96451_i);
    }
    ...
    public void doRenderLiving(EntityLiving par1, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        this.func_110827_b(par1, par2, par4, par6, par8, par9);
    }
