...
public class GuiScreenDemo extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        byte var1 = -16;
        this.buttonList.add(new GuiButton(1, this.width / 2 - 116, this.height / 2 + 62 + var1, 114, 20, I18n.func_135053_a("demo.help.buy")));
        this.buttonList.add(new GuiButton(2, this.width / 2 + 2, this.height / 2 + 62 + var1, 114, 20, I18n.func_135053_a("demo.help.later")));
    }
    ...
    public void drawDefaultBackground()
    {
        ...
        this.mc.func_110434_K().func_110577_a(field_110407_a);
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        this.fontRenderer.drawString(I18n.func_135053_a("demo.help.title"), var4, var5, 2039583);
        var5 += 12;
        GameSettings var7 = this.mc.gameSettings;
        String var6 = I18n.func_135053_a("demo.help.movementShort");
        ...
        var6 = I18n.func_135053_a("demo.help.movementMouse");
        this.fontRenderer.drawString(var6, var4, var5 + 12, 5197647);
        var6 = I18n.func_135053_a("demo.help.jump");
        ...
        var6 = I18n.func_135053_a("demo.help.inventory");
        ...
        this.fontRenderer.drawSplitString(I18n.func_135053_a("demo.help.fullWrapped"), var4, var5 + 68, 218, 2039583);
