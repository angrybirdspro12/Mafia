...
public class GuiScreenBook extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        {
            this.buttonList.add(this.buttonSign = new GuiButton(3, this.width / 2 - 100, 4 + this.bookImageHeight, 98, 20, I18n.func_135053_a("book.signButton")));
            this.buttonList.add(this.buttonDone = new GuiButton(0, this.width / 2 + 2, 4 + this.bookImageHeight, 98, 20, I18n.func_135053_a("gui.done")));
            this.buttonList.add(this.buttonFinalize = new GuiButton(5, this.width / 2 - 100, 4 + this.bookImageHeight, 98, 20, I18n.func_135053_a("book.finalizeButton")));
            this.buttonList.add(this.buttonCancel = new GuiButton(4, this.width / 2 + 2, 4 + this.bookImageHeight, 98, 20, I18n.func_135053_a("gui.cancel")));
        }
        else
        {
            this.buttonList.add(this.buttonDone = new GuiButton(0, this.width / 2 - 100, 4 + this.bookImageHeight, 200, 20, I18n.func_135053_a("gui.done")));
        }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        this.mc.func_110434_K().func_110577_a(field_110405_a);
        ...
        if (this.editingTitle)
        {
            ...
            String var10 = String.format(I18n.func_135053_a("book.byAuthor"), new Object[] {this.editingPlayer.getCommandSenderName()});
        ...
        {
            var6 = String.format(I18n.func_135053_a("book.pageIndicator"), new Object[] {Integer.valueOf(this.currPage + 1), Integer.valueOf(this.bookTotalPages)});
            var7 = "";
