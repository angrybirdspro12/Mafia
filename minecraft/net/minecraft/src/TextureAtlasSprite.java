...
public class TextureAtlasSprite implements Icon
{
    ...
    public void func_110971_a(int par1, int par2, int par3, int par4, boolean par5)
    {
        ...
        this.field_110980_m = (float)(par3 + this.width) / (float)((double)par1) - var6;
        this.field_110977_n = (float)par4 / (float)par2 + var7;
        this.field_110978_o = (float)(par4 + this.height) / (float)par2 - var7;
    }
    ...
    public void updateAnimation()
    {
        ...
        if (this.field_110983_h >= this.field_110982_k.func_110472_a(this.field_110973_g))
        {
            ...
            {
                TextureUtil.func_110998_a((int[])this.field_110976_a.get(var3), this.width, this.height, this.field_110975_c, this.field_110974_d, false, false);
            }
        }
    }
    ...
    public void func_130100_a(Resource par1Resource) throws IOException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                this.field_110982_k = new AnimationMetadataSection(var11, this.width, this.height, var3.func_110469_d());
            }
        }
    }
    ...
    {
        return "TextureAtlasSprite{name=\'" + this.field_110984_i + '\'' + ", frameCount=" + this.field_110976_a.size() + ", rotated=" + this.rotated + ", x=" + this.field_110975_c + ", y=" + this.field_110974_d + ", height=" + this.height + ", width=" + this.width + ", u0=" + this.field_110979_l + ", u1=" + this.field_110980_m + ", v0=" + this.field_110977_n + ", v1=" + this.field_110978_o + '}';
    }
}
