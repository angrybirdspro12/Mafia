...
public class GuiMainMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.func_130020_g();
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, var3 + 72 + 12, 98, 20, I18n.func_135053_a("menu.options")));
        this.buttonList.add(new GuiButton(4, this.width / 2 + 2, var3 + 72 + 12, 98, 20, I18n.func_135053_a("menu.quit")));
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        if (par1GuiButton.id == 14 && this.field_130023_H.drawButton)
        {
            this.func_140005_i();
        }
