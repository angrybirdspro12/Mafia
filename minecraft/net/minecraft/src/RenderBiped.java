...
public class RenderBiped extends RenderLiving
{
    ...
    protected void func_82408_c(EntityLiving par1, int par2, float par3)
    {
        ItemStack var4 = par1.getCurrentArmor(3 - par2);
    ...
    public void doRenderLiving(EntityLiving par1, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        ItemStack var11 = par1.getHeldItem();
        this.func_82420_a(par1, var11);
        double var12 = par4 - (double)par1.yOffset;
        ...
        super.doRenderLiving(par1, par2, var12, par6, par8, par9);
