...
public class GuiMultiplayer extends GuiScreen
{
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        if (par1GuiButton.enabled)
        {
            ...
            else if (par1GuiButton.id == 3)
            {
                ...
                this.mc.displayGuiScreen(new GuiScreenAddServer(this, this.theServerData = new ServerData(I18n.func_135053_a("selectServer.defaultName"), "")));
            }
    ...
    private static void func_74017_b(ServerData par0ServerData) throws IOException
    {
        ...
        try
        {
            ...
            Packet254ServerPing var5 = new Packet254ServerPing(73, var1.getIP(), var1.getPort());
            ...
            if (var6.startsWith("\u00a7") && var6.length() > 1)
            {
                ...
                else
                {
                    ...
                    par0ServerData.field_82821_f = 74;
                    par0ServerData.populationInfo = "" + EnumChatFormatting.DARK_GRAY + "???";
                }
            }
            else
            {
                ...
                par0ServerData.field_82821_f = 72;
            }
        }
        finally
        {
