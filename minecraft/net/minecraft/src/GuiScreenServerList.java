...
public class GuiScreenServerList extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 96 + 12, I18n.func_135053_a("selectServer.select")));
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        this.drawCenteredString(this.fontRenderer, I18n.func_135053_a("selectServer.direct"), this.width / 2, 20, 16777215);
