...
public class GuiScreenOnlineServers extends GuiScreen
{
    ...
    {
        this.buttonList.add(this.field_96196_r = new GuiButton(1, this.width / 2 - 154, this.height - 52, 100, 20, StatCollector.translateToLocal("mco.selectServer.play")));
        this.buttonList.add(this.field_96198_p = new GuiButton(2, this.width / 2 - 48, this.height - 52, 100, 20, StatCollector.translateToLocal("mco.selectServer.create")));
        this.buttonList.add(this.field_96190_o = new GuiButton(3, this.width / 2 + 58, this.height - 52, 100, 20, StatCollector.translateToLocal("mco.selectServer.configure")));
        this.buttonList.add(this.field_96197_q = new GuiButtonLink(4, this.width / 2 - 154, this.height - 28, 154, 20, StatCollector.translateToLocal("mco.selectServer.moreinfo")));
        this.buttonList.add(new GuiButton(0, this.width / 2 + 6, this.height - 28, 153, 20, StatCollector.translateToLocal("gui.cancel")));
        ...
        if (var1 != null && !var1.field_96405_e.equals(this.mc.func_110432_I().func_111285_a()))
        {
            this.field_96190_o.displayString = StatCollector.translateToLocal("mco.selectServer.leave");
        }
    }
    ...
    private void func_140019_s()
    {
        ...
        if (var1 != null)
        {
            if (this.mc.func_110432_I().func_111285_a().equals(var1.field_96405_e))
            {
            ...
            {
                String var4 = StatCollector.translateToLocal("mco.configure.world.leave.question.line1");
                String var3 = StatCollector.translateToLocal("mco.configure.world.leave.question.line2");
    ...
    {
        McoClient var3 = new McoClient(this.mc.func_110432_I());
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        this.drawCenteredString(this.fontRenderer, StatCollector.translateToLocal("mco.title"), this.width / 2, 20, 16777215);
    ...
    private void func_130038_b(int par1, int par2)
    {
        ...
        if (var4 && var3 != 0)
        {
            var5 = par1 + 12;
            var6 = par2 - 12;
            String var7 = StatCollector.translateToLocal("mco.invites.pending");
    ...
    private void func_101008_c(int par1, int par2, int par3, int par4)
    {
        ...
        {
            this.field_96195_s = StatCollector.translateToLocal("mco.selectServer.expired");
        }
    }
    ...
    private void func_104039_b(int par1, int par2, int par3, int par4, int par5)
    {
        ...
        if (par3 >= par1 && par3 <= par1 + 9 && par4 >= par2 && par4 <= par2 + 9)
        {
            if (par5 == 0)
            {
                this.field_96195_s = StatCollector.translateToLocal("mco.selectServer.expires.soon");
            }
            else if (par5 == 1)
            {
                this.field_96195_s = StatCollector.translateToLocal("mco.selectServer.expires.day");
            }
            else
            {
                this.field_96195_s = StatCollector.translateToLocalFormatted("mco.selectServer.expires.days", new Object[] {Integer.valueOf(par5)});
            }
        }
    }
    ...
    private void func_101006_d(int par1, int par2, int par3, int par4)
    {
        ...
        if (par3 >= par1 && par3 <= par1 + 9 && par4 >= par2 && par4 <= par2 + 9)
        {
            this.field_96195_s = StatCollector.translateToLocal("mco.selectServer.open");
        }
    }
    ...
    private void func_101001_e(int par1, int par2, int par3, int par4)
    {
        ...
        if (par3 >= par1 && par3 <= par1 + 9 && par4 >= par2 && par4 <= par2 + 9)
        {
            this.field_96195_s = StatCollector.translateToLocal("mco.selectServer.closed");
        }
    }
    ...
    private void func_96174_a(McoServer par1McoServer) throws IOException
    {
        ...
        try
        {
            ...
            else
            {
                ...
                par1McoServer.field_96415_h = 72;
            }
        }
        finally
        {
    ...
    static FontRenderer func_140025_q(GuiScreenOnlineServers par0GuiScreenOnlineServers)
    {
        return par0GuiScreenOnlineServers.fontRenderer;
    }

    static FontRenderer func_140034_r(GuiScreenOnlineServers par0GuiScreenOnlineServers)
    {
        return par0GuiScreenOnlineServers.fontRenderer;
    }

    static FontRenderer func_140028_s(GuiScreenOnlineServers par0GuiScreenOnlineServers)
    {
        return par0GuiScreenOnlineServers.fontRenderer;
    }

    static String func_140026_a(GuiScreenOnlineServers par0GuiScreenOnlineServers, String par1Str)
    {
        return par0GuiScreenOnlineServers.field_96195_s = par1Str;
    }

    static Minecraft func_140022_t(GuiScreenOnlineServers par0GuiScreenOnlineServers)
    {
        return par0GuiScreenOnlineServers.mc;
    }
}
