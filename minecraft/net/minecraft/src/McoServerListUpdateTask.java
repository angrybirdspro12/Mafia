...
class McoServerListUpdateTask extends TimerTask
{
    ...
    {
        Collections.sort(par1List, new McoServerListUpdateTaskComparator(this, McoServerList.func_100014_a(this.field_140067_a).func_111285_a(), (McoServerListEmptyAnon)null));
    }
