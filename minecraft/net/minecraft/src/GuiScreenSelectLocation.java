...
public abstract class GuiScreenSelectLocation
{
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
            ...
            if (this.field_104102_m == -1.0F)
            {
                ...
                if (par2 >= this.field_104098_a && par2 <= this.field_104096_b)
                {
                    ...
                    if (par1 >= var5 && par1 <= var6)
                    {
                        ...
                        var13 = (int)((float)((this.field_104096_b - this.field_104098_a) * (this.field_104096_b - this.field_104098_a)) / (float)this.getContentHeight());
        ...
        var18.addVertexWithUV((double)this.field_104103_j, (double)(this.field_104098_a + var20), 0.0D, 0.0D, 1.0D);
        var18.addVertexWithUV((double)this.field_104106_i, (double)(this.field_104098_a + var20), 0.0D, 1.0D, 1.0D);
        ...
        var18.setColorRGBA_I(0, 0);
        var18.addVertexWithUV((double)this.field_104106_i, (double)(this.field_104096_b - var20), 0.0D, 1.0D, 0.0D);
        var18.addVertexWithUV((double)this.field_104103_j, (double)(this.field_104096_b - var20), 0.0D, 0.0D, 0.0D);
        var18.draw();
        var19 = this.func_104085_d();

        if (var19 > 0)
        {
            var13 = (this.field_104096_b - this.field_104098_a) * (this.field_104096_b - this.field_104098_a) / this.getContentHeight();
