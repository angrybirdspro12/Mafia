...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public GuiCreateWorld(GuiScreen par1GuiScreen)
    {
        ...
        this.seed = "";
        this.localizedNewWorldText = I18n.func_135053_a("selectWorld.newWorld");
    }
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 155, this.height - 28, 150, 20, I18n.func_135053_a("selectWorld.create")));
        this.buttonList.add(new GuiButton(1, this.width / 2 + 5, this.height - 28, 150, 20, I18n.func_135053_a("gui.cancel")));
        this.buttonList.add(this.buttonGameMode = new GuiButton(2, this.width / 2 - 75, 115, 150, 20, I18n.func_135053_a("selectWorld.gameMode")));
        this.buttonList.add(this.moreWorldOptions = new GuiButton(3, this.width / 2 - 75, 187, 150, 20, I18n.func_135053_a("selectWorld.moreWorldOptions")));
        this.buttonList.add(this.buttonGenerateStructures = new GuiButton(4, this.width / 2 - 155, 100, 150, 20, I18n.func_135053_a("selectWorld.mapFeatures")));
        this.buttonGenerateStructures.drawButton = false;
        this.buttonList.add(this.buttonBonusItems = new GuiButton(7, this.width / 2 + 5, 151, 150, 20, I18n.func_135053_a("selectWorld.bonusItems")));
        this.buttonBonusItems.drawButton = false;
        this.buttonList.add(this.buttonWorldType = new GuiButton(5, this.width / 2 + 5, 100, 150, 20, I18n.func_135053_a("selectWorld.mapType")));
        this.buttonWorldType.drawButton = false;
        this.buttonList.add(this.buttonAllowCommands = new GuiButton(6, this.width / 2 - 155, 151, 150, 20, I18n.func_135053_a("selectWorld.allowCommands")));
        this.buttonAllowCommands.drawButton = false;
        this.buttonList.add(this.buttonCustomize = new GuiButton(8, this.width / 2 + 5, 120, 150, 20, I18n.func_135053_a("selectWorld.customizeType")));
    ...
    private void func_82288_a(boolean par1)
    {
        ...
        if (this.moreOptions)
        {
            this.moreWorldOptions.displayString = I18n.func_135053_a("gui.done");
        }
        else
        {
            this.moreWorldOptions.displayString = I18n.func_135053_a("selectWorld.moreWorldOptions");
        }
    }
    ...
    {
        this.localizedNewWorldText = I18n.func_135052_a("selectWorld.newWorld.copyOf", new Object[] {par1WorldInfo.getWorldName()});
