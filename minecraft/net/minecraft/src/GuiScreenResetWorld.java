...
public class GuiScreenResetWorld extends ScreenWithCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.field_96154_o = new GuiButton(1, this.width / 2 - 100, this.height / 4 + 120 + 12, 97, 20, I18n.func_135053_a("mco.configure.world.buttons.reset")));
        this.buttonList.add(new GuiButton(2, this.width / 2 + 5, this.height / 4 + 120 + 12, 97, 20, I18n.func_135053_a("gui.cancel")));
        ...
        {
            this.buttonList.add(new GuiButton(field_110360_p, this.width / 2 - 100, 125, 200, 20, I18n.func_135053_a("mco.template.default.name")));
        }
        else
        {
            this.field_96151_c.setText("");
            ...
            this.buttonList.add(new GuiButton(field_110360_p, this.width / 2 - 100, 125, 200, 20, I18n.func_135053_a("mco.template.name") + ": " + this.field_110359_q.field_110732_b));
        }
    }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        this.drawCenteredString(this.fontRenderer, I18n.func_135053_a("mco.reset.world.title"), this.width / 2, 17, 16777215);
        this.drawCenteredString(this.fontRenderer, I18n.func_135053_a("mco.reset.world.warning"), this.width / 2, 56, 16711680);
        this.drawString(this.fontRenderer, I18n.func_135053_a("mco.reset.world.seed"), this.width / 2 - 100, 86, 10526880);
