...
class GuiScreenBackupSelectionList extends GuiScreenSelectLocation
{
    ...
    private void func_111246_b(int par1, int par2, int par3, int par4, Tessellator par5Tessellator)
    {
        ...
        this.field_111249_a.drawString(GuiScreenBackup.func_130032_i(this.field_111249_a), "Backup (" + this.func_111248_a(Long.valueOf(MinecraftServer.func_130071_aq() - var6.field_110725_b.getTime())) + ")", par2 + 2, par3 + 1, 16777215);
