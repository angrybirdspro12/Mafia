...
public class GuiScreenInvite extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 96 + 12, I18n.func_135053_a("mco.configure.world.buttons.invite")));
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        if (par1GuiButton.enabled)
        {
            ...
            {
                McoClient var2 = new McoClient(this.mc.func_110432_I());
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        this.drawString(this.fontRenderer, I18n.func_135053_a("mco.configure.world.invite.profile.name"), this.width / 2 - 100, 53, 10526880);
