...
public class GuiScreenCreateOnlineWorld extends ScreenWithCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(field_96253_d, this.width / 2 - 100, this.height / 4 + 120 + 17, 97, 20, I18n.func_135053_a("mco.create.world")));
        this.buttonList.add(new GuiButton(field_96261_n, this.width / 2 + 5, this.height / 4 + 120 + 17, 95, 20, I18n.func_135053_a("gui.cancel")));
        ...
        {
            this.buttonList.add(new GuiButton(field_110357_r, this.width / 2 - 100, 147, 200, 20, I18n.func_135053_a("mco.template.default.name")));
        }
        else
        {
            ...
            this.buttonList.add(new GuiButton(field_110357_r, this.width / 2 - 100, 147, 200, 20, I18n.func_135053_a("mco.template.name") + ": " + this.field_110356_u.field_110732_b));
        }
    }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        this.drawCenteredString(this.fontRenderer, I18n.func_135053_a("mco.selectServer.create"), this.width / 2, 11, 16777215);
        this.drawString(this.fontRenderer, I18n.func_135053_a("mco.configure.world.name"), this.width / 2 - 100, 52, 10526880);
        this.drawString(this.fontRenderer, I18n.func_135053_a("mco.create.world.seed"), this.width / 2 - 100, 98, 10526880);
