...
class GuiSlotServer extends GuiSlot
{
    ...
    protected void elementClicked(int par1, boolean par2)
    {
        if (par1 < GuiMultiplayer.getInternetServerList(this.parentGui).countServers() + GuiMultiplayer.getListOfLanServers(this.parentGui).size())
        {
            ...
            boolean var5 = GuiMultiplayer.getSelectedServer(this.parentGui) >= 0 && GuiMultiplayer.getSelectedServer(this.parentGui) < this.getSize() && (var4 == null || var4.field_82821_f == 73);
    ...
    private void func_77248_b(int par1, int par2, int par3, int par4, Tessellator par5Tessellator)
    {
        ...
        this.parentGui.drawString(this.parentGui.fontRenderer, I18n.func_135053_a("lanServer.title"), par2 + 2, par3 + 1, 16777215);
        ...
        {
            this.parentGui.drawString(this.parentGui.fontRenderer, I18n.func_135053_a("selectServer.hiddenAddress"), par2 + 2, par3 + 12 + 11, 3158064);
        }
        else
        {
    ...
    {
        this.parentGui.drawCenteredString(this.parentGui.fontRenderer, I18n.func_135053_a("lanServer.scanning"), this.parentGui.width / 2, par3 + 1, 16777215);
        String var6;
    ...
    private void func_77247_d(int par1, int par2, int par3, int par4, Tessellator par5Tessellator)
    {
        ...
        boolean var7 = var6.field_82821_f > 73;
        boolean var8 = var6.field_82821_f < 73;
        ...
        this.parentGui.mc.func_110434_K().func_110577_a(Gui.field_110324_m);
        byte var16 = 0;
        boolean var11 = false;
        String var12 = "";
        int var15;
