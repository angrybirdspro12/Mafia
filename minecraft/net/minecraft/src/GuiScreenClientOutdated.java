...
public class GuiScreenClientOutdated extends GuiScreen
{
    ...
    {
        this.field_140007_a = par1GuiScreen;
    }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        String var4 = StatCollector.translateToLocal("mco.client.outdated.title");
        String var5 = StatCollector.translateToLocal("mco.client.outdated.msg");
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
            this.mc.displayGuiScreen(this.field_140007_a);
        }
    }
